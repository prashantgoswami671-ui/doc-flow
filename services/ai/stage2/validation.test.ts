...
describe("FORBIDDEN capabilities", () => {
  it.each([
    ...
    ["36c. page (V7-A04 descriptive locator)", { page: 1 }],
    ["36d. sourcePage (V7-A04.2 renamed locator)", { sourcePage: 1 }],
    ["37. chunkIndex", { chunkIndex: 0 }],
    ["37b. chunk (V7-A04 descriptive locator)", { chunk: 0 }],
    ["37c. sourcePageCount (V7-A04 document denominator)", { sourcePageCount: 6 }],
