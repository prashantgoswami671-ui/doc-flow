...
**Status: 🟡 In progress — SEC-01 through SEC-04 complete; SEC-05 and SEC-06 remaining.**
...
| SEC-06 | **Scope AI data flow** (client-only PDF processing vs. AI-server processing, retention, transmission, consent) — new in v5, must land before Phase 5 ships anything | 🔴 Not started |
